...
namespace Othello
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        SpriteFont font1;
        SpriteFont menufont;
        public static Mode mode = Mode.startscreen;
        ...
        Boolean isZuneHD
        {
            get
            {
                //System.Diagnostics.Debug.WriteLine(GraphicsDevice.DisplayMode.Width);
                if (Program.HD)
                {
                    return true;
                }
                else if (GraphicsDevice.DisplayMode.Width == 272)
                {
                    return true;
                }
                else
        ...
        public Game1()
        {
            ...
            //System.Diagnostics.Debug.WriteLine(GraphicsDevice.DisplayMode.Width);
            /*
            if (gs.Game.GraphicsDevice.DisplayMode.Width == 242)
            {
                zhd = true;
            }
            */
        ...
        public static void ChangeMode(Mode imode)
        {
            mode = imode;
        }
        ...
        protected override void LoadContent()
        {
            ...
            if (!isZuneHD)
            {
                ...
                sel = Content.Load<Texture2D>("Pieces\\Sempty");
            ...
            {
                black = Content.Load<Texture2D>("Pieces\\HD\\Black");
                white = Content.Load<Texture2D>("Pieces\\HD\\White");
                blank = Content.Load<Texture2D>("Pieces\\HD\\Empty");
                sel = Content.Load<Texture2D>("Pieces\\HD\\Sempty");
                selB = Content.Load<Texture2D>("Pieces\\HD\\Sblack");
                selW = Content.Load<Texture2D>("Pieces\\HD\\Swhite");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (mode == Mode.multi)
            {
                ...
                if (isZuneHD)
                {
                    ...
                    /*
                    spriteBatch.DrawString(font1, line[0], vec2frompoint(new Point(120, 60)), col, float.Parse(Math.PI.ToString()), vec2frompoint(new Point(120, 60)) + (font1.MeasureString(line[0]) / 2), 1.0f, SpriteEffects.None, 2f);
                    spriteBatch.DrawString(font1, line[1], vec2frompoint(new Point(0, 60)), Color.Green, float.Parse(Math.PI.ToString()), vec2frompoint(new Point(0, 60)) + (font1.MeasureString(line[1]) / 2), 1.0f, SpriteEffects.None, 2f);
                    spriteBatch.DrawString(font1, line[2], vec2frompoint(new Point(120, 30)), Color.Black, float.Parse(Math.PI.ToString()), vec2frompoint(new Point(120, 30)) + (font1.MeasureString(line[2]) / 2), 1.0f, SpriteEffects.None, 2f);
                    spriteBatch.DrawString(font1, line[3], vec2frompoint(new Point(0, 30)), Color.White, float.Parse(Math.PI.ToString()), vec2frompoint(new Point(0, 30)) + (font1.MeasureString(line[3]) / 2), 1.0f, SpriteEffects.None, 2f);
                    
                    spriteBatch.DrawString(font1, line[0], vec2frompoint(new Point(120, 60)), col, float.Parse(Math.PI.ToString()), vec2frompoint(new Point(120, 60)), 1.0f, SpriteEffects.None, 2f);
                    spriteBatch.DrawString(font1, line[1], vec2frompoint(new Point(0, 60)), Color.Green, float.Parse(Math.PI.ToString()), vec2frompoint(new Point(0, 60)), 1.0f, SpriteEffects.None, 2f);
                    spriteBatch.DrawString(font1, line[2], vec2frompoint(new Point(120, 30)), Color.Black, float.Parse(Math.PI.ToString()), vec2frompoint(new Point(120, 30)), 1.0f, SpriteEffects.None, 2f);
                    spriteBatch.DrawString(font1, line[3], vec2frompoint(new Point(0, 30)), Color.White, float.Parse(Math.PI.ToString()), vec2frompoint(new Point(0, 30)), 1.0f, SpriteEffects.None, 2f);
                    */
                }
                else
                {
        ...
        public void MakeComputerMove()
        {
            ...
            List<Int32> id = arr.FindAll(find);
            ...
            */
            ...
            {
                cmt.Priority = System.Threading.ThreadPriority.Normal;
                MakeMove(1, p.X, p.Y);
            }
            SM["Change Turn"].Play();
            changeturn();
                ...
                if (mode == Mode.single)
                {
                    if (turn == 1)
                    {
                        if (isZuneHD)
                        {
                            ...
                            cmt = new System.Threading.Thread(new System.Threading.ThreadStart(MakeComputerMove));
                            cmt.IsBackground = true;
                            cmt.Priority = System.Threading.ThreadPriority.Lowest;
                            cmt.Name = "Computer Move";
                            cmt.Start();
